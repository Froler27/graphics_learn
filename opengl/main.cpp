...
int main(int argc, char** argv)
{
	...
	Shader shader((strShaderFilePre+"5.1.framebuffers.vs.shader").c_str(),
		(strShaderFilePre+"5.1.framebuffers.fs.shader").c_str());
	Shader screenShader((strShaderFilePre + "5.1.framebuffers_screen.vs.shader").c_str(),
		(strShaderFilePre + "5.1.framebuffers_screen.fs.shader").c_str());
